      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-3 gap-6">
          <div>
            ...
            <p className="text-sm text-gray-400">The Tasty House</p>
            <p className="text-sm text-gray-400 mt-1">Trading Since: April 2020</p>
          </div>
          <div>
        ...
        <div className="border-t border-gray-800 mt-6 pt-6 text-center">
          <p className="text-xs text-gray-400">&copy; 2024 Hinckley Finest. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
